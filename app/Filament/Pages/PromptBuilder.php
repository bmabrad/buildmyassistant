...
class PromptBuilder extends Page
{
    protected static string|BackedEnum|null $navigationIcon = 'heroicon-o-chat-bubble-bottom-center-text';

    protected static ?string $navigationLabel = 'Prompt Builder';

    protected static ?string $title = 'Prompt Builder';
    ...
    public function content(Schema $schema): Schema
    {
        return $schema->components([
            View::make('filament.pages.prompt-builder-chat'),
        ]);
    }

    public function getSegments()
    {
        return PromptSegment::active()->ordered()->get();
    }
